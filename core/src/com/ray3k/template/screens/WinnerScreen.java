...
public class WinnerScreen extends JamScreen {
    ...
    public WinnerScreen(Action action) {
        this.action = action;
    }
    ...
    public void show() {
        ...
        TypingLabel typingLabel = new TypingLabel("You defeated the evil Santa!\nThough there is no more joy in the holidays, our children will no longer be subjected to his reign of terror.\nThis is what growing up must be about.", skin);
